...
@section('content')
    ...
    <div class="card" style="position: relative; top:40%; left:20%; transform:translate(-50%, -50%); width:500px;">
        <form action="/perjalanan/simpanperjalanan" style="position: relative;" method="POST" id="form" novalidate>
            @csrf
            @if (session('message'))
                <div class="alert">
                    {{ session('message') }}
            ...
            <div class="form">
                <input type="text" id="tujuan" name="tujuan" autocomplete="off" class="form-input" placeholder=" ">
